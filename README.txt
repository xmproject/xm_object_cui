...
Dependance:
ROS use the version of opencv is 2.4.9 by default, but we need some functions about nonfree that is not included in opencv2.4.9, so we must download opencv2.4.11 from the opencv office website and compile and install manually. More details information, you can visit below website: http://docs.opencv.org/2.4.11/doc/tutorials/introduction/linux_install/linux_install.html#linux-installation
